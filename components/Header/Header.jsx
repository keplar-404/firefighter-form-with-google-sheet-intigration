        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 text-black">
            <li className="text-gray-600 hover:text-black inter text-[16px]">
              <ScrollLink to="pfas" smooth={true} duration={500} offset={-100}>
                Pfas
              </ScrollLink>
            </li>
            <li className="text-gray-600 hover:text-black inter text-[16px]">
            ...
            <li className="text-gray-600 hover:text-black inter text-[16px]">
              <ScrollLink to="Costs" smooth={true} duration={500} offset={-100}>
                Costs
              </ScrollLink>
            </li>
            <li className="text-gray-600 hover:text-black inter text-[16px]">
            ...
            <li className="text-gray-600 hover:text-black inter text-[16px]">
              <ScrollLink to="Next" smooth={true} duration={500} offset={-100}>
                Next Steps
              </ScrollLink>
            </li>
          </ul>
