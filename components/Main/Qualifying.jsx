          ...
          <div className="w-full sm:px-0 md:px-16 lg:px-24 sm:mt-[5rem] lg:mt-36">
            <Accordion>
              ...
              <Accordion.Panel>
                ...
                <Accordion.Content>
                  <p className="mb-2 text-gray-500 dark:text-gray-400">
                    Exposure does not have to be job-related. Firefighting foam
                    can affect entire communities through drinking water
                    contaminated by chemical runoff. However, most people with a
                    clear link between the contaminant and their condition
              ...
              <Accordion.Panel>
                ...
                <Accordion.Content>
                  <p className="mb-2 text-gray-500 dark:text-gray-400">
                    To qualify, you need to prove that dangerous chemicals from
                    firefighting foam were in your surroundings at high
